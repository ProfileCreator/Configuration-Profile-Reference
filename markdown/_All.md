...
|`allowUSBRestrictedMode`|Boolean|Supervised only. If set to `false`, device will always be able to connect to USB accessories while locked. Defaults to `true`.</br>**Availability:** Available only in iOS 11.5 and later.|
